        ...
        <div class="card-body">
            <div class="row">
                <div class="column d-flex justify-content-end">
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#tambahuser"> Tambah
                        User</button>
                </div>
            </div>
            <!-- modal tambah -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="wahyu34" name="nama" required>
                        ...
                        <div class="modal-body">
                            <form class="text-center needs-validation" novalidate action=""
                                ...
                                <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="wahyu34" name="id_user" value="<?php echo $row['id_user'] ?>" disabled>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="wahyu34" name="nama" value="<?php echo $row['nama'] ?>" disabled>
                                            <label for="floatingInput">Nama</label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-body">
                            <form class="text-center needs-validation" novalidate action="../proses/edit-user.php"
                                ...
                                <div class="col-lg-5">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="wahyu34" value="<?php echo $row['id_user'] ?>" disabled>
                                            <label for="floatingInput">Id User</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="wahyu34" name="nama" value="<?php echo $row['nama'] ?>" required>
                                            <label for="floatingInput">Nama</label>
                                            <div class="invalid-feedback text-start">
                                                Masukan Nama User
                                            </div>
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <button class="btn btn-success btn-sm me-1" data-bs-toggle="modal" data-bs-target="#info<?php echo $row['id_user'] ?>"><i class="bi bi-info-square"></i></button>
                                <button class="btn btn-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#edit<?php echo $row['id_user'] ?>"><i class="bi bi-pencil-square"></i></i></button>
