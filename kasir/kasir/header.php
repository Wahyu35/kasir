...
<nav class="navbar navbar-expand border-bottom border-body bg-success sticky-top" data-bs-theme="dark">
        <div class="container-lg">
            <a class="navbar-brand" href="."><i class="bi bi-wallet"></i> Kasir</a>
                ...
                <form class="text-center needs-validation" novalidate action="proses/ubah-password.php" method="POST">
                  ...
                  <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="wahyu34" name="username"
              ...
              <div class="modal-body">
                <form class="text-center needs-validation" novalidate action="proses/ubah-profile.php" method="POST">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="wahyu" name="nama"
