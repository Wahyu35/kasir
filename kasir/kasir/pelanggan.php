        ...
        <div class="card-body">
            <div class="row">
                <div class="column d-flex justify-content-end">
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#tambahpelanggan"> Tambah
                        Pelanggan</button>
                </div>
            </div>
            <!-- modal tambah -->
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput"
                                                placeholder="wahyu34" name="id" required value="<?php echo rand(1000, 9999) ?>">
                            ...
                            <form class="text-center needs-validation" novalidate action="proses/edit-pelanggan.php"
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput"
                                                placeholder="wahyu34" name="id_pelanggan" required value="<?php echo $row['id_pelanggan'] ?>">
                                            <label for="floatingInput">Id Pelanggan</label>
                                            <div class="invalid-feedback text-start">
                                                Masukan Id Pelanggan
                                            </div>
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                           ...
                           <td class="d-flex">
                             <!--   <button class="btn btn-success btn-sm me-1" data-bs-toggle="modal" data-bs-target="#info<?php echo $row['id_pelanggan'] ?>"><i class="bi bi-info-square"></i></button> -->
                                <button class="btn btn-success btn-sm me-1" data-bs-toggle="modal" data-bs-target="#edit<?php echo $row['id_pelanggan'] ?>"><i class="bi bi-pencil-square"></i></button>
